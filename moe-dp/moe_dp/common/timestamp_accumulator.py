...
def align_timestamps(    
    ...
    if len(global_idxs) == 0:
        raise ValueError(
            "No timestamps could be aligned to the requested target_global_idxs. "
            f"timestamps={timestamps}, start_time={start_time}, dt={dt}, "
            f"target_global_idxs={target_global_idxs}"
        )
